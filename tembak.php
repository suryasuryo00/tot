...
echo color("red","| status : siap dipakai |\n");
echo color("red","| by Eko suryono       |\n");
...
// function change(){
        ...
        sleep(3);
        $boba10 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"R56559700034"}');
        ...
        sleep(3);
        $goride1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"R56559700034"}');
